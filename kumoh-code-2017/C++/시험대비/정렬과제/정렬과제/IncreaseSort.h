...
public:
	void increaseSort()
	{
		...
		case 5:
			...
			break;
		case 6:
			increase_Mid_QuickSort();
			break;
		case 7:
			increase_NonR_Mid_QuickSort();
			break;
		case 8:
			increase_InsertSort();
			break;
		case 9:
			increase_Binary_InsertSort();
			break;
		case 10:
			increase_Linked_InsertSort();
			break;
		case 11:
			increase_NonR_MergeSort();
			break;
		case 12:
			increase_Natural_MergeSort();
			break;
		case 13:
			increase_R_MergeSort();
			break;
		case 14:
			return;
		}
	...
	void increase_BubbleSort()
	{
		...
		if (select == 1) //int
		{
			...
			cout << endl << "Increase Array : Type<Int>" << endl;

			int *intArr0 = new int[1000];

			in.open(to_string(1000) + "_Increase.txt");
			...
			in.open(to_string(5000) + "_Increase.txt");
			...
			in.open(to_string(10000) + "_Increase.txt");
			...
			in.open(to_string(100000) + "_Increase.txt");
		...
		else if (select == 2) //Double
		{
			...
			cout << endl << "Increase Array : Type<Double>" << endl;
			...
			in.open(to_string(50000) + "_Increase.txt");
		...
		else if (select == 3)
		{
			...
			cout << endl << "Increase Array : Type<String>" << endl;
		...
		else if (select == 4)
		{
			...
			cout << endl << "Increase Array : Type<Circle>" << endl;
	...
	void increase_QuickSort()
	{
		...
		if (select == 1) //int
		{
			...
			cout << endl << "QuickSort : Type<Int>" << endl;

			unsigned int *intArr0 = new unsigned int[1000];
			...
			unsigned int *intArr1 = new unsigned int[5000];
			...
			unsigned int *intArr2 = new unsigned int[10000];
			...
			unsigned int *intArr3 = new unsigned int[50000];
			...
			unsigned int *intArr4 = new unsigned int[100000];
	...
	void increase_NonR_Mid_QuickSort()
	{
		cout << "[ 테스트 타입 ]" << endl;
		cout << " 1. Integer\n" << " 2. Double\n" << " 3. String\n" << " 4. Circle\n" << " 5. Exit " << endl;
		cout << " : ";
	...
	void increase_Binary_InsertSort()
	{
		cout << "[ 테스트 타입 ]" << endl;
		cout << " 1. Integer\n" << " 2. Double\n" << " 3. String\n" << " 4. Circle\n" << " 5. Exit " << endl;
		cout << " : ";
		...
		else if (select == 2)
		{
			...
			double *circleArr0 = new double[1000];
			...
			double *circleArr1 = new double[5000];
			...
			double *circleArr2 = new double[10000];
			...
			double *circleArr3 = new double[50000];
			...
			double *circleArr4 = new double[100000];
	...
	void increase_Linked_InsertSort()
	{
		cout << "[ 테스트 타입 ]" << endl;
		cout << " 1. Integer\n" << " 2. Double\n" << " 3. String\n" << " 4. Circle\n" << " 5. Exit " << endl;
		cout << " : ";
	...
	void increase_Natural_MergeSort()
	{
		cout << "[ 테스트 타입 ]" << endl;
		cout << " 1. Integer\n" << " 2. Double\n" << " 3. String\n" << " 4. Circle\n" << " 5. Exit " << endl;
		cout << " : ";
