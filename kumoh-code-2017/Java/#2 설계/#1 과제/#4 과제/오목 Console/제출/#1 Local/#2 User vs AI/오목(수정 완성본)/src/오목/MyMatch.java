	...
	public void play(int sizeMenu)
	{
		...
		if(sizeMenu == 1)
		{
			while(true)
			{
				...
				{
				case 1:	// 1. 게임 진행
					System.out.println("---------- 게임 타입메뉴          ----------");
					System.out.println("---------- 1. Local     ----------");
					System.out.println("---------- 2. Network   ----------");
					System.out.println("---------- 3. 선택 종료         ----------");
					System.out.print("선택 : ");
						...
						while(true)
						{
							...
							if(boardMenu == 1)
							{
								...
								if(playerMenu == 1)
								{
									...
									System.out.println("(1: User vs User, 2 : User vs AI)");
									System.out.print("선택 : ");
					...
					{
						System.out.println("입력 범위 초과! (0 ~ 3)");
					}
					break;
				case 2:	// 2. 게임 정보
					displayMatchInfo();
