...
{
	public ComputerPlayer(int id, String name, int order, int playerType, int winningRate, StoneType stoneType)
	{
		super(id, name, order, playerType, winningRate, stoneType);
	}
